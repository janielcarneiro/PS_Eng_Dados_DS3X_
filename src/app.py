...
#####################################################################
#####################################################################
#COMENTE ESSE CODIGO, DEPOIS RENOMEAR O ARQUIVO É DEPOIS PODE EXECUTAR
# O CODIGO ABAIXO

# 1 - COMENTE O CODIGO ABAIXO
# 2 - RENOMEAR OS ARQUIVOS
# 3 - EXECUTE O CODIGO ABAIXO É COMENTE O DE CIMA
#####ESSA PARTE VAI CARREGAR TODOS OS DADOS NO CLOUD BIGQUERY#####
